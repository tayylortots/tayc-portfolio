          ...
          <ScrollReveal delay={0.1}>
            <div onClick={() => setShowCaseStudy(true)} className="cursor-pointer">
              ...
              >
                ...
                <img alt="Advanced Search Interface" className="absolute w-full h-full top-0 left-0 object-contain p-4" src={portfolio.mainPortfolioImage} />                {/* Hover Overlay - Enhanced plastic glossy effect */}
