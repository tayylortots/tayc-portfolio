            ...
            <div>
              ...
              <div className="bg-[#9caa9c] h-[300px] md:h-[500px] rounded-[8px] mb-[38px] relative overflow-hidden">
                <div className="absolute h-[420px] w-[591px] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                  <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[8px] size-full" src={caseStudy} loading="lazy" />
                </div>
              </div>
          ...
          <div className="max-w-[1000px] mx-auto px-4 md:px-8 border-0">
            ...
            <div className="bg-[#485248] h-[300px] md:h-[500px] rounded-[8px] relative overflow-hidden">
              <div className="absolute h-[420px] left-1/2 -translate-x-1/2 rounded-[8px] top-1/2 -translate-y-1/2 w-[744px]">
                <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[8px] size-full" src={svgPaths.p40ebb20} loading="lazy" />
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-[38px]">
                ...
                <div className="flex flex-col gap-[16px]">
                  <div className="bg-[#485248] h-[500px] rounded-[8px] relative overflow-hidden flex items-center justify-center">
                    <img alt="" className="max-w-[90%] max-h-[90%] object-contain rounded-[4px]" src={svgPaths.p40ebb20} />
                  </div>
                  ...
                  <div className="bg-[#485248] h-[500px] rounded-[8px] relative overflow-hidden">
                    <div className="absolute rounded-[8px] inset-[23.21%_8.35%_23.51%_8.5%]">
                      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[8px]">
                        <img alt="" className="absolute h-[110.18%] left-0 max-w-none top-[-0.02%] w-full" src={svgPaths.p40ebb20} />
                      </div>
                    </div>
                ...
                <div className="flex flex-col gap-[16px]">
                  <div className="bg-[#485248] h-[500px] rounded-[8px] relative overflow-hidden">
                    <div className="absolute rounded-[8px] inset-[11.9%_11.81%_20.24%_11.97%]">
                      <div className="absolute inset-0 overflow-hidden pointer-events-none rounded-[8px]">
                        <img alt="" className="absolute h-[120.18%] left-[-0.04%] max-w-none top-0 w-[100.08%]" src={svgPaths.p40ebb20} />
                      </div>
                    </div>
                  ...
                  <div className="bg-[#485248] h-[500px] rounded-[8px] relative overflow-hidden flex items-center justify-center">
                    <div className="relative w-[350px] h-[350px]">
                      ...
                      <div className="absolute top-[60px] left-[20px] right-[55px] rounded-[4px]">
                        <img alt="" className="w-full h-auto object-contain rounded-[4px]" src={svgPaths.p40ebb20} />
                      </div>
                      <div className="absolute top-[135px] left-[37.5px] h-[91px] w-[265px] rounded-[4px] shadow-[0px_2px_13.8px_0px_rgba(0,0,0,0.25)]">
                        <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[4px] size-full" src={svgPaths.p40ebb20} />
                      </div>
              ...
              <div className="flex gap-[36px] items-center justify-center relative">
                <div className="flex flex-col gap-[8px] items-center w-[150px]">
                  <div className="rounded-[8px] size-[132px] relative overflow-hidden">
                    <img alt="" className="w-full h-full object-cover rounded-[8px]" src={svgPaths.p40ebb20} />
                  </div>
              ...
              <div className="flex flex-col lg:flex-row gap-[20px] lg:gap-[40px] items-center">
                <div className="bg-[#485248] h-[300px] md:h-[400px] lg:h-[500px] w-full lg:w-[530px] rounded-[8px] relative overflow-hidden flex-shrink-0">
                  <div className="absolute h-[196px] w-[500px] left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2">
                    <img alt="" className="absolute inset-0 max-w-none object-cover size-full" src={svgPaths.p40ebb20} />
                  </div>
                </div>
                <div className="flex-1">
              ...
              <div className="flex flex-col lg:flex-row gap-[20px] lg:gap-[40px] items-center">
                <div className="bg-[#485248] h-[300px] md:h-[400px] lg:h-[500px] w-full lg:w-[530px] rounded-[8px] overflow-clip relative flex-shrink-0">
                  <div className="absolute h-[190px] left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2 w-[459px]">
                    <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full" src={svgPaths.p40ebb20} />
                  </div>
                </div>
                <div className="flex-1">
            ...
            <div className="mb-[60px]">
              ...
              <div className="bg-[#485248] h-[300px] md:h-[500px] rounded-[8px] relative overflow-hidden">
                <div className="absolute h-[420px] w-[744px] left-1/2 -translate-x-1/2 rounded-[8px] top-1/2 -translate-y-1/2">
                  <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[8px] size-full" src={svgPaths.p40ebb20} />
                </div>
              </div>
            </div>
                ...
                <div className="flex flex-col gap-[16px]">
                  <div className="bg-[#485248] h-[400px] md:h-[500px] rounded-[8px] flex items-center justify-center overflow-hidden relative">
                    <div className="absolute h-[230px] w-[410px] left-1/2 -translate-x-1/2 top-1/2 -translate-y-1/2">
                      <img alt="" className="absolute inset-0 max-w-none object-cover object-center rounded-[4px] size-full" src={svgPaths.p40ebb20} />
                    </div>
                  </div>
        ...
        <div className="max-w-[1000px] mx-auto px-4 md:px-8 pt-[60px] md:pt-[120px]">
          <div className="mb-[60px] md:mb-[120px]">
            ...
            <div className="h-auto max-w-full md:h-[376px] md:w-[656px] mx-auto">
              <img alt="" className="w-full h-auto md:max-w-none md:object-cover md:size-full" src={svgPaths.p40ebb20} />
            </div>
          </div>
        </div>
      </ScrollReveal>
